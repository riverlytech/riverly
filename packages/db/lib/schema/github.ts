import { integer, pgTable, timestamp, unique, varchar, text } from "drizzle-orm/pg-core";
...
export const gitHubInstallationTable = pgTable(
  "github_installation",
  {
    ...
    accountType: varchar("account_type", { length: 64 }).$type<GitHubAccountType>().notNull(),
...
export type GitHubInstallationTable = typeof gitHubInstallationTable.$inferSelect;
