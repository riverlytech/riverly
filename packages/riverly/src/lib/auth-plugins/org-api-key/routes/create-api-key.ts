  ...
  return createAuthEndpoint(
    "/org-api-key/create",
    {
      ...
      body: z.object({
        ...
        organizationId: z.coerce
          ...
          .meta({
            description:
              'Organization Id of the user that the Api Key belongs to. server-only. Eg: "ogranization-id"',
          })
          .optional(),
        prefix: z
          .string()
    ...
    async (ctx) => {
      ...
      let data: Omit<ApiKey, "id"> = {
        ...
        rateLimitEnabled:
          rateLimitEnabled === undefined ? (opts.rateLimit.enabled ?? true) : rateLimitEnabled,
        requestCount: 0,
