...
interface OrgAPIKeyPluginOptions {
  timeWindow: number;
  rateLimitMax: number;
}

export const apiKeySchema = (opts: OrgAPIKeyPluginOptions) =>
  ({
    apikey: {
      fields: {
        /**
        ...
        /**
         * The organization id of the organiztion which the key belongs to.
         */
        organizationId: {
          type: "string",
        ...
        rateLimitMax: {
          ...
          required: false,
          input: false,
          defaultValue: opts.rateLimitMax,
        },
        /**
